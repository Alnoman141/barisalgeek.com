                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 d-flex justify-content-end">
                                <a href="{{ route('admin.category.create') }}" class="btn btn-info m-2">Create Category</a>
                            </div>
                        </div>
                        <hr>
                        @include('global.msg')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(Auth::user()->role != 'Editor')
                                            <a class="btn btn-danger btn-sm" href="#deleteCategory{{ $category->id }}" data-toggle="modal" data-target="">Delete</a>
                                        @endif
                                    <!--Delete Modal -->
